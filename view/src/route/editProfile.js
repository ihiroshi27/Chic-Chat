...
class EditProfile extends React.Component {
	...
	onProfileChange = (event) => {
		if (event.target.value === "") {
			...
			profile.setAttribute("src", API_URL + '/static/' + this.state.user.profile);
							...
							<div className="form">
								<form encType="multipart/form-data" onSubmit={ this.onSubmit }>
									<div className="input-icon">
										...
										<input name="name" type="text" placeholder="Name" defaultValue={ this.state.user.name } required />
									</div>
									<div className="input-icon">
										<i className="fas fa-envelope"></i>
										<input name="email" type="email" placeholder="Email" defaultValue={ this.state.user.email } required />
									</div>
									<div className="input-icon">
										<i className="fas fa-mobile"></i>
										<input name="mobile" type="text" pattern="[0-9]{10}" placeholder="Mobile" defaultValue={ this.state.user.mobile } required />
									</div>
									<div className="input-icon">
										<i className="fas fa-id-card"></i>
										<input name="citizen_id" type="text" pattern="[0-9]{13}" placeholder="Citizen ID" defaultValue={ this.state.user.citizen_id } required />
									</div>
